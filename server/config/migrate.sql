-- Admission Management System Database Migration
-- For Neon PostgreSQL
...
-- Insert admission requirements for Computer Science
INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'Mathematics', 'C6', true FROM programmes WHERE code = 'CS001'
ON CONFLICT DO NOTHING;

INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'English', 'C6', true FROM programmes WHERE code = 'CS001'
ON CONFLICT DO NOTHING;

INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'Science', 'C6', true FROM programmes WHERE code = 'CS001'
ON CONFLICT DO NOTHING;

-- Insert admission requirements for Business Administration
INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'Mathematics', 'C6', true FROM programmes WHERE code = 'BA001'
ON CONFLICT DO NOTHING;

INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'English', 'C6', true FROM programmes WHERE code = 'BA001'
ON CONFLICT DO NOTHING;

-- Insert admission requirements for Nursing
INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'Mathematics', 'C6', true FROM programmes WHERE code = 'NS001'
ON CONFLICT DO NOTHING;

INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'English', 'C6', true FROM programmes WHERE code = 'NS001'
ON CONFLICT DO NOTHING;

INSERT INTO admission_requirements (programme_id, subject, minimum_grade, is_required)
SELECT id, 'Science', 'C6', true FROM programmes WHERE code = 'NS001'
ON CONFLICT DO NOTHING;

-- Create a sample admission officer
INSERT INTO users (email, password_hash, role, first_name, last_name, is_active, email_verified)
VALUES ('officer@presbyuniversity.edu.gh', '$2b$10$qS9VEEUWey0l8oLl.T0.lu98W7o8UoxL18B1p8S8a1L2xzsg8LKnK', 'officer', 'Admission', 'Officer', true, true)
ON CONFLICT (email) DO NOTHING;
